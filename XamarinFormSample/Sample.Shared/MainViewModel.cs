...
namespace AuthgearSample
{
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        public string AuthgearEndpoint { get; set; } =
            Preferences.Get("authgear.endpoint", Config.AuthgearEndpoint);
        public string OauthProviderAlias { get; set; } =
            Preferences.Get("authgear.oauthProviderAlias", "");
        ...
        private ColorScheme? SystemColorScheme
        {
            get
            {
                return AppInfo.RequestedTheme == AppTheme.Dark
                    ? Authgear.Xamarin.ColorScheme.Dark
                    : Authgear.Xamarin.ColorScheme.Light;
            }
        }

        public DateTimeOffset? AuthTime
        {
            get { return authgear.AuthTime; }
        }
        ...
        {
            get { return IsConfigured && IsNotLoading && SessionState == SessionState.NoSession; }
        }
        ...
        {
            get { return IsEnabledReauthenticateWeb; }
        }
        ...
        public async Task ConfigureAsync()
        {
            try
            {
                ...
                if (UseTransientStorage)
                {
                    tokenStorage = new TransientTokenStorage();
                }
                else
                {
                    tokenStorage = new PersistentTokenStorage();
                }
                ...
                authgear.SessionStateChange += (sender, e) =>
                {
                    if (!MainThread.IsMainThread)
                    {
                        throw new InvalidOperationException(
                            "Session state change isn't dispatched on the main thread"
                        );
                    }
                    _ = SyncAuthgearState();
                };
        ...
        private void EnsureIsMainThread(string methodName)
        {
            ...
            {
                throw new InvalidOperationException(
                    $"await in {methodName} didn't resume on the main thread"
                );
            }
        }
        ...
        private void EnsureAuthgear()
        {
            ...
            {
                throw new InvalidOperationException(
                    "Authgear is not configured. Did you forget to click configure?"
                );
            }
        }
        ...
        public async Task PromoteAnonymousUserAsync()
        {
            ...
            {
                SetIsLoading(true);
                UserInfo = await authgear.PromoteAnonymousUserAsync(
                    new PromoteOptions(RedirectUri) { ColorScheme = ColorScheme, }
                );
        ...
        public async Task AuthenticateAsync()
        {
            ...
            {
                SetIsLoading(true);
                UserInfo = await authgear.AuthenticateAsync(
                    new AuthenticateOptions(RedirectUri)
                    {
        ...
        public async Task ReAuthenticateAsync(bool useBiometric)
        {
            ...
            try
            {
                ...
                UserInfo = await authgear.ReauthenticateAsync(
                    new ReauthenticateOptions(RedirectUri)
                    {
                        ColorScheme = ColorScheme,
                        UiLocales = new List<string> { },
                    },
        ...
        private BiometricOptions CreateBiometricOptions()
        {
            return new BiometricOptions
            {
                Android = new BiometricOptionsAndroid(
                    ...
                    "Cancel",
                    BiometricAccessConstraintAndroid.BiometricOnly,
                    true
                ),
                Ios = new BiometricOptionsIos(
                    "Use biometric to authenticate",
                    BiometricAccessConstraintIos.BiometricCurrentSet,
        ...
        private void Notify()
        {
            PropertyChanged?.Invoke(
                this,
                new PropertyChangedEventArgs(nameof(IsEnabledAuthenticate))
            );
            PropertyChanged?.Invoke(
                this,
                new PropertyChangedEventArgs(nameof(IsEnabledAuthenticateBiometric))
            );
            PropertyChanged?.Invoke(
                this,
                new PropertyChangedEventArgs(nameof(IsEnabledReauthenticateWeb))
            );
            PropertyChanged?.Invoke(
                this,
                new PropertyChangedEventArgs(nameof(IsEnabledReauthenticate))
            );
            PropertyChanged?.Invoke(
                this,
                new PropertyChangedEventArgs(nameof(IsEnabledEnableBiometric))
            );
            PropertyChanged?.Invoke(
                this,
                new PropertyChangedEventArgs(nameof(IsEnabledDisableBiometric))
            );
            PropertyChanged?.Invoke(
                this,
                new PropertyChangedEventArgs(nameof(IsEnabledFetchUserInfo))
            );
            PropertyChanged?.Invoke(
                this,
                new PropertyChangedEventArgs(nameof(IsEnabledOpenSettings))
            );
            PropertyChanged?.Invoke(
                this,
                new PropertyChangedEventArgs(nameof(IsEnabledShowAuthTime))
            );
